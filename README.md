...
Additionally, the mathematical convergence and correctness of the root-free iteration are completely formally verified in Lean 4 (with 0 `sorry`s). The proofs guarantee the soundness of the Newton-Schulz root construction and are included in the repository.
...
- `leanproofs/`: formal verification of the RFS root properties in Lean 4 (0 `sorry`s).
